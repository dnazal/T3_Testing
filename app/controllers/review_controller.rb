...
class ReviewController < ApplicationController
  ...
  def insertar
    ...
    if @review.save
      ...
      flash[:error] = 'Hubo un error al guardar la reseña; debe completar todos los campos solicitados.'
    end
